...
Source0  : https://download.kde.org/stable/applications/18.12.3/src/kdesdk-thumbnailers-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/kdesdk-thumbnailers-18.12.3.tar.xz.sig
...
%prep
%setup -q -n kdesdk-thumbnailers-18.12.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1555329054
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
