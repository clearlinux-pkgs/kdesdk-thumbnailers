...
Version  : 20.08.2
Release  : 24
URL      : https://download.kde.org/stable/release-service/20.08.2/src/kdesdk-thumbnailers-20.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/kdesdk-thumbnailers-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/kdesdk-thumbnailers-20.08.2.tar.xz.sig
...
%prep
%setup -q -n kdesdk-thumbnailers-20.08.2
cd %{_builddir}/kdesdk-thumbnailers-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602642696
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesdk-thumbnailers-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kdesdk-thumbnailers-20.08.2/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
