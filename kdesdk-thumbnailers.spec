...
Version  : 24.12.3
Release  : 80
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kdesdk-thumbnailers-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kdesdk-thumbnailers-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kdesdk-thumbnailers-24.12.3.tar.xz.sig
...
%setup -q -n kdesdk-thumbnailers-24.12.3
cd %{_builddir}/kdesdk-thumbnailers-24.12.3
pushd ..
cp -a kdesdk-thumbnailers-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742492156
mkdir -p clr-build
pushd clr-build
