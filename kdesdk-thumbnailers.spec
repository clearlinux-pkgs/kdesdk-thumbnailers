...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kdesdk-thumbnailers-22.08.0.tar.xz
...
%prep
%setup -q -n kdesdk-thumbnailers-22.08.0
cd %{_builddir}/kdesdk-thumbnailers-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661551765
mkdir -p clr-build
pushd clr-build
