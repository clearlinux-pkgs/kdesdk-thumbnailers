...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/kdesdk-thumbnailers-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/kdesdk-thumbnailers-22.04.2.tar.xz.sig
...
%prep
%setup -q -n kdesdk-thumbnailers-22.04.2
cd %{_builddir}/kdesdk-thumbnailers-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654840765
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesdk-thumbnailers-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kdesdk-thumbnailers-22.04.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kdesdk-thumbnailers-22.04.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kdesdk-thumbnailers-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kdesdk-thumbnailers-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdesdk-thumbnailers/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
