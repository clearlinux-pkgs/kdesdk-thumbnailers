...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kdesdk-thumbnailers-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kdesdk-thumbnailers-25.04.2.tar.xz.sig
...
%setup -q -n kdesdk-thumbnailers-25.04.2
cd %{_builddir}/kdesdk-thumbnailers-25.04.2
pushd ..
cp -a kdesdk-thumbnailers-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749519223
mkdir -p clr-build
pushd clr-build
